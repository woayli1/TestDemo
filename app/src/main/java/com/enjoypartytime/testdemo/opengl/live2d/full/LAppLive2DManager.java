...
package com.enjoypartytime.testdemo.opengl.live2d.full;


import static com.enjoypartytime.testdemo.opengl.live2d.LAppDefine.*;
...
public class LAppLive2DManager {
    ...
    public void setUpModel() {
        ...
        final AssetManager assets = LAppDelegate.getInstance().getActivity().getResources()
                .getAssets();
        try {
    ...
    public void changeScene(int index) {
        ...
        LAppDelegate.getInstance().getView()
                .setRenderingTargetClearColor(clearColor[0], clearColor[1], clearColor[2]);
    }
