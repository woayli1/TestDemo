...
import com.enjoypartytime.testdemo.opengl.glVideo.other.EFrameBufferObjectRenderer;
...
import com.enjoypartytime.testdemo.opengl.glVideo.view.ESurfaceTexture;
...
public class EPlayerRenderer extends EFrameBufferObjectRenderer implements SurfaceTexture.OnFrameAvailableListener {
    ...
    public void onSurfaceCreated(final EGLConfig config) {
        ...
        new Handler(Looper.getMainLooper()).post(() -> {
            simpleExoPlayer.setVideoSurface(new Surface(previewTexture.getSurfaceTexture()));
        });
