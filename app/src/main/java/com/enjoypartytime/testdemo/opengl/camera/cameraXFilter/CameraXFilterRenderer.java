...
import com.enjoypartytime.testdemo.opengl.camera.cameraXFilter.filter.BaseCameraXFilter;
import com.enjoypartytime.testdemo.opengl.camera.cameraXFilter.filter.CameraXFilterBlackWhite;
import com.enjoypartytime.testdemo.opengl.camera.cameraXFilter.filter.CameraXFilterGray;
import com.enjoypartytime.testdemo.opengl.camera.cameraXFilter.filter.CameraXFilterNegative;
import com.enjoypartytime.testdemo.opengl.camera.cameraXFilter.filter.CameraXFilterNone;
import com.enjoypartytime.testdemo.opengl.camera.cameraXFilter.filter.CameraXFilterX2;
import com.enjoypartytime.testdemo.opengl.camera.cameraXFilter.filter.CameraXFilterY2;
