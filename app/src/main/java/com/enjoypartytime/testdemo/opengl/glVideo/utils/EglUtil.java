package com.enjoypartytime.testdemo.opengl.glVideo.utils;
...
public class EglUtil {
    ...
    public static String loadAsset(Context context, final String assetPath) {
        try {
            return Util.loadAsset(context, assetPath);
        } catch (IOException e) {
