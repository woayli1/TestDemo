...
//         前回セーブされた状態をロード
    ...
    private void setupModel(ICubismModelSetting setting) {
        ...
        breathParameters.add(new CubismBreath.BreathParameterData(CubismFramework.getIdManager()
                .getId(ParameterId.BREATH.getId()), 0.5f, 0.5f, 3.2345f, 0.5f));
    ...
    private void setupTextures() {
        for (int modelTextureNumber = 0; modelTextureNumber < modelSetting.getTextureCount(); modelTextureNumber++) {
            ...
            this.<CubismRendererAndroid>getRenderer()
